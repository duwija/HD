...
<section class="content-header">
  ...
  <div class="card card-primary card-outline">
             ...
             <button type="button" class="float-right btn bg-primary btn-sm" data-toggle="modal" data-target="#modal-jurnal"> Add New jurnal </button>
              </div>
               ...
               <form role="form" method="post" action="/jurnal">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror " name="name" id="name"  placeholder="jurnal Name" value="{{old('name')}}">
                    @error('name')
