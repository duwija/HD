@extends('layout.main')
@section('title','New Closing Jurnal Item')
@section('maps')
...
<section class="content-header">
  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title font-weight-bold text-uppercase"> Add New Item </h3>



    </div>
    <p class="text-center text-uppercase p-2 "><strong>Closing Journal</strong> </p>
    <form role="form" method="post" action="/jurnal/closed">
      @csrf
      <div class="card-body row">
        <div class="form-group col-md-6">
                ...
                <input type="hidden" name="type" id="type" value="preclosed">
        <div class="form-group col-md-6">
        ...
        <div class="form-group  col-md-6">
          ...
          <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description" placeholder="Site Descrition " value="Jurnal Penutup">
          @error('description')
          <div class="error invalid-feedback">{{ $message }}</div>
          @enderror
        </div>
...
<div class="card card-primary card-outline">
  ...
  <form role="form" method="post" action="/jurnal/closeupdate">
      @csrf
...
@endphp
    ...
    <tr class="bg-primary">
      ...
      <td colspan=""><strong>{{number_format($kredit, 0, ',', '.')}}</strong></td>
        ...
        <td colspan="2"></td>
         <td colspan=""><strong> <button type="" class="btn btn-success">Post to Buku Besar</button> </strong></td>
